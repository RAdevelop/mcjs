...
INSERT INTO `blog_image` VALUES (1,3,1485621605,1485621606,NULL,NULL,'/user/blog/0/3/1/c16a5320fa475530d9583c34fd356ef5',0,'_gp_2126.gallery_full_top_fullscreen.jpg');
...
INSERT INTO `blog_list` VALUES (1,1484764276,1484764276,'GoPro Hero 3 Black Edition No SD SD ERROR','gopro-hero-3-black-edition-no-sd-sd-error','Сталкнулся с такой проблемой, камера перестала видеть карторчку, на дисплее были сообщения \"NO SD\" или \"SD ERROR\". Предшествовало этому следующее. Во-первых, стоит отметить, что карточка у нас была MicroSD SanDisk Ultra 64Gb класса 10. И вот во время одной из поездок на мотоцикле, услышав сигнал бипера на камере GoPro Hero 3 Black Edition, что съемка прекращена, остановился. Смотрю, на дисплее высвечено \"NO SD\". В тот момент, хотелось верить, что просто закончилось место на карточке.','<p>Сталкнулся с такой проблемой, камера перестала видеть карторчку, на дисплее были сообщения \"NO SD\" или \"SD ERROR\". Предшествовало этому следующее. Во-первых, стоит отметить, что карточка у нас была&nbsp;MicroSD SanDisk Ultra 64Gb класса 10. И вот во время одной из поездок на мотоцикле, услышав сигнал бипера на камере GoPro Hero 3&nbsp;Black Edition, что съемка прекращена, остановился. Смотрю, на дисплее высвечено \"NO SD\". В тот момент, хотелось верить, что просто закончилось место на карточке.</p>\r\n<p>Что еще предшествовало этому. Странное прекращение съемки после примерно 5-7 секунд. Приходилось запускать съемку заново. С каого-то момента съемка не прекращалась, то есть камера вела себя нормально.&nbsp;</p>\r\n<p>Но когда приехал домой, обнаружил следующее. Карточка на компьютере определяется, файлы с нее можно копировать. Но вот ни удалить, ни отформатировать карточку не удавалось. Ни средствами компьютера, ни средствами самой камеры. Надо отметить, что на карточку записался битый видео файл. Испробовал разные утилиты для форматирования, и даже ту, которая вроде бы форматирует карточку на так называемом \"низком уровне\" - SD Formatter. В общем, перепробовал все, что мог найти в сети. В том числе проделать те же операции форматировать на Mac OS. Результат нулевой - карточка не форматируется, но определяется на компьютере, и с нее можно копировать файлы. При вставке в камеру GoPro Hero 3&nbsp;Black Edition, все то же сообщение \"NO SD\".</p>\r\n<p>Решил приобрести уже другую карточку&nbsp;64Gb Kingston SDXC Class 10. Приехал в магазин, купил, тут же вставил в камеру. Вроде бы все в порядке. Но решил проверить опцию форматирования карточки средствами самой камеры. После форматирования камера выдала сообщение \"SD ERROR\". Вынул карточку, вставил обратно, включил камеру - \"NO SD\". Тут же понес карточку в техническую (гарантийную) службу. Сообщаю, что карточка не определяется в камере. Вставив у них карточку в компьютер, обнаруживается, что она не определяется и там. Выписали мне замену на такую же карточку. В общем, это процесс повторился еще два раза. После форматирования карточки в камере, карточка не определялась ни в камере, ни на комьютере. Сделал возврат денег, так как никаких технических повреждений с карточкой не было. Решил изучить такую проблему в Интернете.</p>\r\n<p>Почитав зарубежные сайты, нашел такую же проблему. Не вдаваясь особо в подробности изысканий, скажу следующее. Пользователи камеры&nbsp;GoPro Hero 3&nbsp;Black Edition могут столкнуться с такой проблемой именно с карточками на 64Gb класса 10. Что рекомендуют. Купить карточку на 32Gb класса 10. Если нужно именно 64Gb, покупайте две такие карточки по 32Gb. И форматируйте карточки только средствами компьютера, а не камеры GoPro Hero 3.</p>\r\n<p>Последовав этому совету, приобрел карточку&nbsp;32Gb MicroSD Kingston Class 10. Тут же в магазине вставил в камеру - все в порядке. Но уже не стал форматировать карточку средствами камеры. Снял примерно 5-ти минутный видеоролик, сделал несколько фотографий. Попросил парней из гарантийной службы на компьютере открыть снятые видео и фотографии. Все в порядке - открылись, видео проигрывалось. Попросил отформатировать карточку на компьютере (для карточек 32Gb используется файловая ситема FAT32, не форматируйте такие карточки в exFAT - этот формат предназначен для карточек объемом свыше 32Gb). Для своего успокоения я проделал такую процедуры раза три: форматирования карточки на компьютере, съемка фото и видео.</p>\r\n<p>Все стало работать без проблем. Съемка не прекращалась после 5-7 секунд, карточка читается нормально. Средставми камеры карточку уже не форматирую. Но тут надо отметить, что обнволения для камеры у меня были еще февральские 2013 (точнее те, что были актуальны на февраль месяц). А вот 4-го апреля 2013 у&nbsp;GoPro Hero 3 на сайте производителя вышли новые обновления. Возможно, что если бы я обновил своевременно камеру еще раз, то избежал бы вышеуказанных проблем. Но это только мои предположения, так как на сайте производителя GoPro в разделе обновлний программно-аппаратных средств так и не удалось найти, что же они \"починили\".</p>\r\n<p>Вот такие новости по использованию камеры&nbsp;GoPro Hero 3&nbsp;Black Edition с карточками на 64Gb. Пока что езжу с 32Gb, в качестве эксперимента. Проблем не возникает. Но в ближайшем будущем все же попробую купить карточку на 64Gb, но уже не форматировать средствами камеры :)</p>\r\n<p>Всем удачи на дорогах!</p>',1,0,1),(2,1484775595,1484775595,'Выезжаем в город','viezgaem-v-gorod','Прежде чем вы соберетесь идти в гараж, я считаю, что ваша поездка должна начинаться еще дома. Что я хочу сказать. Если вы собрались просто прокатиться, или поехать в какое-то определенное место, в любом случае рекомендуется составить хотя бы примерный маршрут вашего пути следования.','<p>Прежде чем вы соберетесь идти в гараж, я считаю, что ваша поездка должна начинаться еще дома. Что я хочу сказать. Если вы собрались просто прокатиться, или поехать в какое-то определенное место, в любом случае рекомендуется составить хотя бы примерный маршрут вашего пути следования. Если вы ездите по одному и тому же пути, все равно, прокрутите у себя в голове, как именно вы поедите. Если маршрут будет новым, изучите его на карте. Если в вашем городе есть такое явление как дорожные пробки, ознакомьтесь с ситуацией на дороге: где свободно, где пробка&hellip; Возможно, из-за этого вы измените свой маршрут. Если едите по обычному для вас маршруту, постарайтесь вспомнить какие участки дороги, перекрестки, съезды могут вызвать наибольшую опасность. А когда будете ехать, постарайтесь такие места примечать и запоминать.</p>\r\n<p>Мысленно представив, как вы поедите, вы себя настраиваете на дорогу, и частично подготовитесь к возможным ситуациям. По дороге в гараж, можете даже мысленно смоделировать различные ситуации, и варианты развития событий. Это, конечно же, при условии, что поедите по обычному для вас маршруту. К тому же, таким образом вы сможете себя отвлечь от имеющихся забот, каких-то проблем. Потому что садиться на мотоцикл необходимо с &laquo;холодной&raquo; головой, и вас ничего не должно волновать, отвлекать. Сейчас ваша задача благополучно доехать до пункта назначения. Кстати говоря, чем мне так нравится управлять мотоциклом кроме других причин, так это то, что с мотоциклом я &laquo;забываю&raquo; обо всем остальном. И пока я &laquo;в седле&raquo;, кроме дороги меня ничего не волнует, и не отвлекает &ndash; вот так он на меня действует.</p>\r\n<p>Придя в гараж, прежде чем заводить мотоцикл проведите его осмотр: работают ли все осветительные приборы, чистые ли они, уровень масла, как натянута цепь, не подтекает ли где, давление в шинах, в порядке ли тормоза, загорается ли стоп сигнал при нажатии на ручку и лапку тормоза. Проводить осмотр рекомендуется, даже если вы вчера вечером, уходя из гаража, проделывали эту процедуру. Пусть это войдет у вас в привычку.</p>\r\n<p>После этого можно заводить свой байк. Я, например, всегда прогреваю свою &laquo;подружку&raquo; Honda CBR600RR до 70 градусов, плюс минус. Пока она разогревается ;) можно спокойно успеть переодеться в экипировку.</p>\r\n<p>Всегда одевайтесь полностью в экипировку: шлем, &laquo;спина&raquo;, мотокуртка, мотоштаны (или мотокомбинезон) , мотоботы, перчатки. Визор у шлема всегда должен быть чистым, без каких-либо даже мелких пятен. Никогда не пренебрегайте экипировкой, даже если лето, и на улице под 30 градусов тепла. Не слушайте тех, кто говорит, что шлема будет достаточно. Даже на месте, если вы не удержите мотоцикл, можно получить серьезную травму. Или, например, можете перед очередной поездкой проделать следующее: проведите без усилий внешней стороной кисти по асфальту... А теперь представьте, что будет если, не дай Бог, вы будете без экипировки, и в случае аварии, будете скользить по асфальту после падания...</p>\r\n<p>Не поленитесь, найдите возможность приобрести все необходимое. На лето можете взять мотоштаны и курту с перфорацией, на начало и завершение сезона кожаный комбинезон. Да, стоимость их не всегда радует, но ваша безопасность и здоровье еще дороже. Под конец мотосезона, если у вас чего-то нет из экипировки, задумайтесь об этом. Поищите магазины, у многих могут начаться акции со скидками. Если на данный момент все же нет средств на покупку недостающих элементов экипировки, поставьте себе цель в межсезонье накопить средства, чтобы к следующему сезону вы были полностью экипированы. Рекомендуется еще приобрести термобелье. Его не обязательно искать в специализированных мотомагазинах, можете зайти в обычный спортивный магазин, и поискать термобьлье там. Как правило, в спортивных магазинах оно стоит дешевле.</p>\r\n<p>Ваш байк прогрелся, и вы готовы ехать. На всякий случай еще раз осмотрите мотоцикл на предмет какой-либо течи. Выезжая на дорогу, не торопитесь разгоняться, ваша резина еще не прогрелась. К тому же, если территория вашего гаража, или парковки не вся асфальтирована, на вашей резине остается песок, или элементы гравия. На асфальтированной дороге проедте просто прямо, потом слегка понаклоняйте байк из стороны в сторону. Предварительно убедитесь, что за вами достаточная дистанция до следующего за вами транспорта, и вы никому не помешаете такими маневрами. Таким образом, вы можете избавиться от налипшего на резину песка или гравия. Если же этот участок дороги короткий, но все же мало оживленный, не поленитесь, прокатитесь по нему пару раз, чтобы &laquo;почистить&raquo; резину. Выезжая уже на оживленную дорогу, сцепление с ней у вас должно быть &laquo;подготовленным&raquo;.</p>\r\n<p>Не забывайте пользоваться указателями поворотов! :)</p>\r\n<p>Соблюдайте правила дорожного движения! Всем удачи на дорогах! :)</p>',12,0,1),(3,1485126095,1485621606,'Для чего нужны МотоКлубы и какие они должны быть','dlya-chego-nugni-motoklubi-i-kakie-oni-dolgni-bit','Общаясь на одном из форумов на тему того, что такое мотоклуб, какой он должен быть, и в каких случаях можно именовать себя участником клуба, у меня сложилось следующее мнение на этот счет.','<p>Общаясь на одном из форумов на тему того, что такое мотоклуб, какой он должен быть, и в каких случаях можно именовать себя участником клуба, у меня сложилось следующее мнение на этот счет.</p>\r\n<p>Считать себя клубом в общем-то можно, даже если вы организовали некий интернет ресурс, где могут общаться мотобратья и сестры, например, у которых одна и та же модель мотоцикла. Но я считаю, что организованный кем-либо мотоклуб, это больше чем просто клуб, как кружок по интересам. Я хочу сказать, что стоит стремиться к тому, чтобы у вашего мотоклуба были цели и задачи, которые в первую очередь помогали бы вашему клубу и по возможности другим клубам, и тем, кто не состоит в них.</p>\r\n<p>Что значит мотоклуб для меня, какой он должен быть. Сказанное далее легко написать, чем сделать, тут я согласен, но считаю, что к этому следует стремиться.</p>\r\n<p>У клуба должны быть правила, а лучше даже устав, которому должны следовать все, кто состоит в клубе, или хочет в него вступить. При этом, устав или правила клуба не должны нести в себе вред (жизни или здоровья, или вносить какую-либо рознь по любым признакам) между участниками клуба, или между клубом и теми, кто не в нем не стостоит. Вес голоса в клубе должен быть одинаковый у всех, не зависимо от того, кто как активно проявлет себя. Конечно же, это должно быть в рамках разумного. Иначе просто теряется сама суть мотоциклиста, а суть его заключается в первую очередь в свободе. Но это конечно не означает, что дозволено все. В первую очередь надо жить и действовать по совести.</p>\r\n<p>Клуб должен планировать проведения различных мероприятий, которые могли бы улучшить, например, уровень владения мотоциклом, практика оказание первой медицинской помощи. Такие мероприятия следует проводить регулярно. Организовать фонд помощи друг для друга, стараться ругулярно помогать семьям, в которых, не дай Бог, кто-то попал в больницу, или семья осталась без отца или матери... Как это сделать? Главное тут не терять конткаты друг с другом в таких ситуациях, и не стесняться предлагать или просить о помощи. Одну палку сломать просто, но если сложить вместе две, три..., то уже сложнее и практически невозможно. Как бы громко это не звучало - вместе мы сила.</p>\r\n<p>Очень часто мотоциклисты спрашивают между собой, кто в какой сервис рекомедует обратиться, если возникает в этом необходимость. Мотоклубу можно организовать свой сервис, если будут желающие для этого. Многие вещи можно делать самостоятельно, но порой без обращения в сервис не обойтись. Свой, или тот сервис, который наиболее рекомендуют участники клуба - это не только удобно, но и взаимовыгодно. У мотосервиса будут постоянные клиенты, у клиентов, то есть нас, будет надежный сервис, в который можно будет всегда обратиться и не волноваться на счет качества работы. Если качество работы будет плохим, то об этом информация между соклубниками быстро распространится, и мотосервис не просто потеряет своих клиентов, он потеряет репутацию. Кстати, это одна из причин, для чего здесь на сайте предоставлена возможность порекомендовать или не рекомендать тот или иной мотосалон в один клик.</p>\r\n<p>Так же клубу, или нескольким клубам стоит проводить некие акции по взаимодействию с ГИБДД, контактировать на предмет того, опять же, как можно помочь друг другу в чем-либо.</p>\r\n<p>А если в силах, то возможно взять на попечительство детские дома. Сложно, дорого? Возможно и так. Но попробовать можно. Даже оказание какой-либо помощи одному детскому дому раз в пол года или в год, это все же лучше чем совсем не помогать. И не скрою то, что это так же будет нацелено на то, чтобы сломать стериотипы, которые сложились о мотоциклистах среди граждан.</p>\r\n<p>Кого зачислять, а кого не зачислять в клуб. Это решать вам. В общем, можно зачислять всех, кто согласен соблюдать устав вашего клуба. Если кто-либо нарушает его, лучше исключать. Но для этого сначала следует составить устав, и на своем примере следовать ему.</p>\r\n<p>Старайтесь, если можно так сказать, сотрудничать с другими мотоклубами. Даже если у кого-то из вас возникли ранее в чем-то разногласия, это не повод для того, чтобы совсем не общаться, и не помогать друг другу. Иначе это будет противоречить самому главному - байкер всегда поможет байкеру при любых обстоятельстсвах.</p>\r\n<p>Вливайтесь в существующие клубы, проявляйте инициативу, или создавайте свои клубы. Делайте их такими, чтобы их существование было полезно вам и окружающим.</p>',1,1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='храним информацию о роутерах проекта';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `events_locations` VALUES (3,70),(3,254),(3,345),(3,346),(4,70),(4,278);
...
CREATE TABLE `menu` (
  ...
  `m_show` tinyint(1) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`m_id`),
  UNIQUE KEY `m_name` (`m_name`,`m_path`),
  UNIQUE KEY `mpath` (`m_type`,`m_path`),
  KEY `cid` (`c_id`),
  KEY `lrk_level` (`m_lk`,`m_rk`,`m_level`),
  KEY `type_level` (`m_type`,`m_show`,`m_level`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='храним информацию о меню сайта (не админка)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `menu` VALUES (1,11,'/chat','Чат','Чат','Чат','Чат',2,18,19,9,1,1),(2,11,'/news','Новости','Новости','Новости','Новости',2,16,17,6,1,1),(3,11,'/user','МотоСоседи','МотоСоседи','МотоСоседи','МотоСоседи',2,10,11,13,1,1),(4,11,'/blog','Блог','Блог','Блог','Блог',2,14,15,7,1,1),(5,11,'/events','МотоСобытия','МотоСобытия','МотоСобытия','МотоСобытия',2,20,21,8,1,1),(7,11,'/mototreki','МотоТреки','МотоТреки','МотоТреки','МотоТреки',2,24,25,10,1,1),(8,11,'/motosaloni','МотоСалоны','МотоСалоны','МотоСалоны','МотоСалоны',2,22,23,11,1,1),(9,11,'/admoto','Объявления','Объявления','Объявления','Объявления',2,12,13,12,1,0),(10,12,'/admin/user/groups','Группы пользователей','Группы пользователей','Группы пользователей','Группы пользователей',2,34,35,20,0,0),(11,0,'/','Главная страница','Главная страница','Главная страница','Главная страница',1,9,26,21,1,1),(12,0,'/admin','Админка','Админка','Админка главная страница','Админка главная страница',1,27,36,1,0,0),(13,12,'/admin/menu','Меню сайта','Меню сайта','Меню сайта','Меню сайта',2,28,29,5,0,0),(14,12,'/admin/controller','Контроллеры','Контроллеры (роутеры) сайта','Контроллеры (роутеры) сайта','Контроллеры (роутеры) сайта',2,30,31,4,0,0),(15,12,'/admin/user','Пользователи','Пользователи','Пользователи','Пользователи',2,32,33,22,0,0),(16,0,'/profile','Профиль пользователя','Профиль пользователя','Профиль пользователя','Профиль пользователя',1,1,8,23,2,1),(17,16,'/profile/photo','Фотографии','Фотографии','Фотографии','Фотографии',2,2,3,24,2,1),(18,16,'/profile/video','Видео','Видео','Видео','Видео',2,4,5,25,2,1),(20,16,'/profile/blog','Блог','Блог','Блог','Блог',2,6,7,26,2,1);
...
INSERT INTO `users_groups_rights` VALUES (1,1,9,34),(1,2,6,42),(1,2,6,43),(1,2,6,44),(1,2,6,45),(1,2,6,46),(1,2,6,47),(1,3,13,21),(1,4,7,65),(1,4,7,66),(1,4,7,67),(1,4,7,68),(1,4,7,69),(1,4,7,70),(1,5,8,35),(1,5,8,36),(1,5,8,37),(1,5,8,38),(1,5,8,39),(1,5,8,40),(1,5,8,41),(1,7,10,28),(1,7,10,29),(1,7,10,30),(1,7,10,31),(1,7,10,32),(1,7,10,33),(1,8,11,22),(1,8,11,23),(1,8,11,24),(1,8,11,25),(1,8,11,26),(1,8,11,27),(1,10,20,19),(1,10,20,20),(1,10,20,50),(1,11,21,9),(1,11,21,63),(1,11,21,64),(1,12,1,1),(1,12,1,2),(1,12,1,5),(1,12,1,6),(1,12,1,7),(1,12,1,8),(1,13,5,12),(1,13,5,13),(1,13,5,14),(1,14,4,15),(1,14,4,16),(1,14,4,17),(1,15,22,10),(1,15,22,11),(1,15,22,48),(1,16,23,51),(1,16,23,52),(1,16,23,53),(1,16,23,54),(1,16,23,55),(1,17,24,56),(1,17,24,57),(1,17,24,58),(1,18,25,59),(1,18,25,60),(1,18,25,61),(1,18,25,62),(1,20,26,71),(1,20,26,72),(1,20,26,73),(1,20,26,74),(1,20,26,75),(1,20,26,76),(2,1,9,34),(2,2,6,42),(2,2,6,43),(2,2,6,44),(2,2,6,45),(2,2,6,46),(2,2,6,47),(2,3,13,21),(2,4,7,65),(2,4,7,66),(2,4,7,67),(2,4,7,68),(2,4,7,69),(2,4,7,70),(2,5,8,35),(2,5,8,36),(2,5,8,37),(2,5,8,38),(2,5,8,39),(2,5,8,40),(2,5,8,41),(2,7,10,28),(2,7,10,29),(2,7,10,30),(2,7,10,31),(2,7,10,32),(2,7,10,33),(2,8,11,22),(2,8,11,23),(2,8,11,24),(2,8,11,25),(2,8,11,26),(2,8,11,27),(2,10,20,19),(2,10,20,20),(2,10,20,50),(2,11,21,9),(2,11,21,63),(2,11,21,64),(2,12,1,1),(2,12,1,2),(2,12,1,5),(2,12,1,6),(2,12,1,7),(2,12,1,8),(2,13,5,12),(2,13,5,13),(2,13,5,14),(2,14,4,15),(2,14,4,16),(2,14,4,17),(2,15,22,10),(2,15,22,11),(2,15,22,48),(2,16,23,51),(2,16,23,52),(2,16,23,53),(2,16,23,54),(2,16,23,55),(2,17,24,56),(2,17,24,57),(2,17,24,58),(2,18,25,59),(2,18,25,60),(2,18,25,61),(2,18,25,62),(2,20,26,71),(2,20,26,72),(2,20,26,73),(2,20,26,74),(2,20,26,75),(2,20,26,76),(3,1,9,34),(3,2,6,42),(3,3,13,21),(3,4,7,65),(3,4,7,66),(3,4,7,67),(3,4,7,68),(3,4,7,69),(3,4,7,70),(3,5,8,35),(3,5,8,40),(3,7,10,28),(3,7,10,33),(3,8,11,22),(3,8,11,27),(3,11,21,9),(3,11,21,63),(3,11,21,64),(3,16,23,51),(3,16,23,52),(3,16,23,53),(3,16,23,54),(3,16,23,55),(3,17,24,56),(3,17,24,57),(3,17,24,58),(3,18,25,59),(3,18,25,60),(3,18,25,61),(3,18,25,62),(3,20,26,71),(3,20,26,72),(3,20,26,73),(3,20,26,74),(3,20,26,75),(3,20,26,76),(4,1,9,34),(4,2,6,42),(4,4,7,65),(4,5,8,35),(4,5,8,40),(4,7,10,28),(4,7,10,33),(4,8,11,22),(4,8,11,27),(4,11,21,9),(4,11,21,64);
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`mc`@`%` PROCEDURE `menu_create`(IN inMenuPid INT, IN inAfterId INT, IN inMenuPath VARCHAR(255), IN inMenuName VARCHAR(100), IN inMenuTitle TEXT, IN inMenuH1 TExt, IN inMenuDesc TEXT, IN inCId INT, IN inType INT, IN inShow INT,OUT last_ins_id INT)
BEGIN
	DECLARE i_level INT DEFAULT 1;
	DECLARE i_right_key INT DEFAULT 1;
	DECLARE res INT DEFAULT 0;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`mc`@`%` PROCEDURE `menu_update`(IN inMenuId INT, IN inMenuPid INT, IN inAfterId INT, IN inMenuPath VARCHAR(255), IN inMenuName VARCHAR(100), IN inMenuTitle TEXT, IN inMenuH1 TEXT, IN inMenuDesc TEXT, IN inCId INT, IN inType INT, IN inShow INT,OUT res INT)
BEGIN
