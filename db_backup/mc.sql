...
INSERT INTO `menu` VALUES (1,11,'/chat','Чат','Чат','Чат','Чат',2,10,11,9,1),(2,11,'/news','Новости','Новости','Новости','Новости',2,8,9,6,1),(3,11,'/user','МотоСоседи','МотоСоседи','МотоСоседи','МотоСоседи',2,2,3,13,1),(4,11,'/blog','Блог','Блог','Блог','Блог',2,6,7,7,1),(5,11,'/events','МотоСобытия','МотоСобытия','МотоСобытия','МотоСобытия',2,12,13,8,1),(7,11,'/mototreki','МотоТреки','МотоТреки','МотоТреки','МотоТреки',2,16,17,10,1),(8,11,'/motosaloni','МотоСалоны','МотоСалоны','МотоСалоны','МотоСалоны',2,14,15,11,1),(9,11,'/admoto','Объявления','Объявления','Объявления','Объявления',2,4,5,12,1),(10,12,'/admin/user/groups','Группы пользователей','Группы пользователей','Группы пользователей','Группы пользователей',2,34,35,20,0),(11,0,'/','Главная страница','Главная страница','Главная страница','Главная страница',1,1,18,21,1),(12,0,'/admin','Админка','Админка','Админка главная страница','Админка главная страница',1,27,36,1,0),(13,12,'/admin/menu','Меню сайта','Меню сайта','Меню сайта','Меню сайта',2,28,29,5,0),(14,12,'/admin/controller','Контроллеры','Контроллеры (роутеры) сайта','Контроллеры (роутеры) сайта','Контроллеры (роутеры) сайта',2,30,31,4,0),(15,12,'/admin/user','Пользователи','Пользователи','Пользователи','Пользователи',2,32,33,22,0),(16,0,'/profile','Профиль пользователя','Профиль пользователя','Профиль пользователя','Профиль пользователя',1,19,26,23,2),(17,16,'/profile/photo','Фотографии','Фотографии','Фотографии','Фотографии',2,20,21,24,2),(18,16,'/profile/video','Видео','Видео','Видео','Видео',2,22,23,25,2),(20,16,'/profile/blog','Блог','Блог','Блог','Блог',2,24,25,26,2);
...
INSERT INTO `users` VALUES (1,'roalexey@yandex.ru','$2a$12$NEx59eykcG03xtnYWl1uhO','$2a$12$NEx59eykcG03xtnYWl1uhOH93DYoU.bkctUsu.9lJdcqq.B2zS.pO',1447968485,1485125134,'MotoCommunity',1,'1'),(12,'roalexey@mail.ru','$2a$12$kZC3laKG9y9dU7Xh2kVJA.','$2a$12$kZC3laKG9y9dU7Xh2kVJA.2.I7Fb5Drdk6yLwdUJFII/U1uAr5MFC',1480860847,1485124540,'RoLex',1,'3'),(13,'ra@zero.ru','$2a$12$.1PK0Bzgl/m.x0A/3CfAoO','$2a$12$.1PK0Bzgl/m.x0A/3CfAoOu09nMeFXE2xshnJJJfRQ1Ac5MDrs9E2',1483898742,1484330676,'',1,'3');
...
-- Dump completed on 2017-01-23  1:46:12
