...
class Calendar
{
	...
	static _calendar(baseUrl = '', year = null, month = null, selectedDate = {}, dateList = [])
	{
		...
		let table = `<table class="calendar"><caption><a href="${baseUrl}/${prevYear}/${prevMoth}/" class="fa fa-2x fa-fw fa-long-arrow-left floatLeft"></a><a href="${baseUrl}/${year}/${month+1}/">${Calendar.namesMonth[month]} ${year}</a><a href="${baseUrl}/${nextYear}/${nextMoth}/" class="fa fa-2x fa-fw fa-long-arrow-right floatRight"></a></caption>
